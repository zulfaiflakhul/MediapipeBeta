...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatImageButton maxHandsMinus;

  @NonNull
  public final AppCompatImageButton maxHandsPlus;

  @NonNull
  public final TextView maxHandsValue;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull TextView inferenceTimeVal, @NonNull AppCompatImageButton maxHandsMinus,
      @NonNull AppCompatImageButton maxHandsPlus, @NonNull TextView maxHandsValue,
    ...
    this.maxHandsMinus = maxHandsMinus;
    this.maxHandsPlus = maxHandsPlus;
    this.maxHandsValue = maxHandsValue;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.max_hands_minus;
      AppCompatImageButton maxHandsMinus = ViewBindings.findChildViewById(rootView, id);
      if (maxHandsMinus == null) {
        break missingId;
      }

      id = R.id.max_hands_plus;
      AppCompatImageButton maxHandsPlus = ViewBindings.findChildViewById(rootView, id);
      if (maxHandsPlus == null) {
        break missingId;
      }

      id = R.id.max_hands_value;
      TextView maxHandsValue = ViewBindings.findChildViewById(rootView, id);
      if (maxHandsValue == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout,
          ...
          inferenceTimeLabel, inferenceTimeVal, maxHandsMinus, maxHandsPlus, maxHandsValue,
